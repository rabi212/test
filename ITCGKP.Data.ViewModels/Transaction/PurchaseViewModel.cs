...
namespace ITCGKP.Data.ViewModels.Transaction
{
    public class PurchaseViewModel
    {
        ...
        //[Required(ErrorMessage = "The Date field must be required")]
        [Remote(action: "IsOrderDateValidation", controller: "DateCheck")]
        ...
        public virtual List<PurchaseDetailViewModel>  PurchaseDetailViewModels { get; set; }
        public PurchaseViewModel()
        {
            PurchaseDetailViewModels = new List<PurchaseDetailViewModel>();
        }        
        public int CurrentNo { get => PurchaseDetailViewModels.Count() + 1; }
